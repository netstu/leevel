...
zend_class_entry *queryyetsimple_router_iurl_ce;
...
zend_class_entry *queryyetsimple_router_irouter_ce;
...
zend_class_entry *queryyetsimple_http_jsonresponse_ce;
...
zend_class_entry *queryyetsimple_http_apiresponse_ce;
zend_class_entry *queryyetsimple_http_filebag_ce;
zend_class_entry *queryyetsimple_http_filenotfoundexception_ce;
zend_class_entry *queryyetsimple_http_fileresponse_ce;
zend_class_entry *queryyetsimple_http_redirectresponse_ce;
...
zend_class_entry *queryyetsimple_router_url_ce;
...
static PHP_MINIT_FUNCTION(queryyetsimple)
{
	...
	ZEPHIR_INIT(Queryyetsimple_Router_IUrl);
	...
	ZEPHIR_INIT(Queryyetsimple_Router_IRouter);
	...
	ZEPHIR_INIT(Queryyetsimple_Http_JsonResponse);
	...
	ZEPHIR_INIT(Queryyetsimple_Http_ApiResponse);
	ZEPHIR_INIT(Queryyetsimple_Http_FileBag);
	ZEPHIR_INIT(Queryyetsimple_Http_FileNotFoundException);
	ZEPHIR_INIT(Queryyetsimple_Http_FileResponse);
	ZEPHIR_INIT(Queryyetsimple_Http_RedirectResponse);
	...
	ZEPHIR_INIT(Queryyetsimple_Router_Url);
