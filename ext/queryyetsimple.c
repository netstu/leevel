...
zend_class_entry *queryyetsimple_http_provider_register_ce;
...
zend_class_entry *queryyetsimple_pipeline_provider_register_ce;
...
static PHP_MINIT_FUNCTION(queryyetsimple)
{
	...
	ZEPHIR_INIT(Queryyetsimple_Http_Provider_Register);
	...
	ZEPHIR_INIT(Queryyetsimple_Pipeline_Provider_Register);
