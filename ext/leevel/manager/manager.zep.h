...
ZEPHIR_INIT_FUNCS(leevel_manager_manager_method_entry) {
	...
	PHP_ME(Leevel_Manager_Manager, getContainerOption, arginfo_leevel_manager_manager_getcontaineroption, ZEND_ACC_PROTECTED)
	PHP_ME(Leevel_Manager_Manager, setContainerOption, arginfo_leevel_manager_manager_setcontaineroption, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
