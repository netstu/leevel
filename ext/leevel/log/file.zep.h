...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_file_save, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, datas, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_file_formatmessage, 0, 0, 1)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_ARRAY_INFO(0, contexts, 1)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(leevel_log_file_method_entry) {
	PHP_ME(Leevel_Log_File, save, arginfo_leevel_log_file_save, ZEND_ACC_PUBLIC)
