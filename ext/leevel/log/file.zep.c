...
PHP_METHOD(Leevel_Log_File, flush) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&datas), _1)
	{
		...
		zephir_check_call_status();
		ZVAL_LONG(&_5$$3, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_6, 111, &_2$$3, &_5$$3, &filepath);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Log_File, checkSize) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "clearstatcache", NULL, 112);
	zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_FUNCTION(&_24, "filesize", NULL, 113, &filePath);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_FUNCTION(&_26$$7, "basename", NULL, 114, &filePath, &_25$$7);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "rename", NULL, 115, &filePath, &_29$$7);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Log_File, normalizePath) {
	...
	ZEPHIR_CALL_FUNCTION(&_10, "date", NULL, 116, &_9);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Log_File, formatMessage) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "date", NULL, 116, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_LONG(&_4, 256);
