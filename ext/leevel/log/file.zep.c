...
ZEPHIR_INIT_CLASS(Leevel_Log_File) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Leevel\\Log, File, leevel, log_file, leevel_log_connect_ce, leevel_log_file_method_entry, 0);
 ...
 * @return void
 */
PHP_METHOD(Leevel_Log_File, save) {
	...
	zephir_array_fetch_long(&_0, &datas, 0, PH_NOISY | PH_READONLY, "leevel/log/file.zep", 55 TSRMLS_CC);
	zephir_array_fetch_long(&_1, &_0, 0, PH_NOISY | PH_READONLY, "leevel/log/file.zep", 55 TSRMLS_CC);
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&datas), _2)
	{
		...
		ZVAL_LONG(&_9$$3, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_10, 108, &_8$$3, &_9$$3, &filepath);
		zephir_check_call_status();
