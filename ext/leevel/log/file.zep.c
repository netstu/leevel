...
PHP_METHOD(Leevel_Log_File, flush) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&datas), _1)
	{
		...
		zephir_check_call_status();
		ZVAL_LONG(&_5$$3, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_6, 110, &_2$$3, &_5$$3, &filepath);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Log_File, checkSize) {
	...
	ZEPHIR_CALL_FUNCTION(&dirname, "dirname", &_0, 44, &filePath);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "is_file", &_2, 40, &filePath);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		ZEPHIR_CALL_FUNCTION(&_3$$3, "is_dir", &_4, 42, &dirname);
		zephir_check_call_status();
		if (!(zephir_is_true(&_3$$3))) {
			ZEPHIR_CALL_FUNCTION(&_5$$4, "dirname", &_0, 44, &dirname);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&_6$$4, "is_dir", &_4, 42, &_5$$4);
			zephir_check_call_status();
			_7$$4 = zephir_is_true(&_6$$4);
			if (_7$$4) {
				ZEPHIR_CALL_FUNCTION(&_8$$4, "dirname", &_0, 44, &dirname);
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_9$$4, "is_writable", &_10, 43, &_8$$4);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(NULL, "mkdir", NULL, 45, &dirname, &_15$$4, &__$true);
			zephir_check_call_status();
		}
		ZEPHIR_CALL_FUNCTION(&_16$$3, "is_writable", &_10, 43, &dirname);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "clearstatcache", NULL, 111);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_20, "is_file", &_2, 40, &filePath);
	zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_FUNCTION(&_24, "filesize", NULL, 112, &filePath);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_FUNCTION(&_26$$7, "basename", NULL, 113, &filePath, &_25$$7);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "rename", NULL, 114, &filePath, &_29$$7);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Log_File, normalizePath) {
	...
	ZEPHIR_CALL_FUNCTION(&_10, "date", NULL, 115, &_9);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Log_File, formatMessage) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "date", NULL, 115, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_LONG(&_4, 256);
