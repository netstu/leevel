...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_option, 0, 0, 2)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_optionarray, 0, 0, 2)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_ARRAY_INFO(0, value, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_options, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_getoption, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_INFO(0, defaults)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_getoptions, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_deleteoption, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_log_log_deleteoptions, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_log_log_method_entry) {
	...
	PHP_ME(Leevel_Log_Log, option, arginfo_leevel_log_log_option, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, optionArray, arginfo_leevel_log_log_optionarray, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, options, arginfo_leevel_log_log_options, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, getOption, arginfo_leevel_log_log_getoption, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, getOptions, arginfo_leevel_log_log_getoptions, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, deleteOption, arginfo_leevel_log_log_deleteoption, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_Log_Log, deleteOptions, arginfo_leevel_log_log_deleteoptions, ZEND_ACC_PUBLIC)
