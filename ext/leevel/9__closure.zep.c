...
ZEPHIR_INIT_CLASS(leevel_9__closure) {
	...
	ZEPHIR_REGISTER_CLASS(leevel, 9__closure, leevel, 9__closure, leevel_9__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(leevel_9__closure, __invoke) {
	...
	ZEPHIR_CALL_FUNCTION(&hash, "spl_object_hash", NULL, 136, &closures);
