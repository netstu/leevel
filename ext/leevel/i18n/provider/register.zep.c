...
ZEPHIR_INIT_CLASS(Leevel_I18n_Provider_Register) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Leevel\\I18n\\Provider, Register, leevel, i18n_provider_register, leevel_di_provider_ce, leevel_i18n_provider_register_method_entry, 0);
...
PHP_METHOD(Leevel_I18n_Provider_Register, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, leevel_i18n_provider_register_ce, getThis(), "__construct", &_0, 0, container);
...
PHP_METHOD(Leevel_I18n_Provider_Register, providers) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Leevel\\I18n\\I18n");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Leevel\\I18n\\II18n");
	zephir_array_fast_append(&_0, &_1);
	zephir_array_update_string(&tmp, SL("i18n"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_array(&_0, 1, 0 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Leevel\\I18n\\Load");
	zephir_array_fast_append(&_0, &_1);
...
PHP_METHOD(Leevel_I18n_Provider_Register, i18n) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, leevel_16__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "i18n");
...
PHP_METHOD(Leevel_I18n_Provider_Register, i18nLoad) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, leevel_17__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Leevel_I18n_Provider_Register, console) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "Leevel\\I18n\\Console");
