...
PHP_METHOD(Leevel_Collection_Collection, make) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 76, elements, type);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Collection_Collection, current) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("current", NULL, 46, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Collection_Collection, key) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("key", NULL, 45, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Collection_Collection, next) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&next, "next", NULL, 77, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Collection_Collection, rewind) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(NULL, "reset", NULL, 78, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (1) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Leevel_Collection_Collection, prev) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&prev, "prev", NULL, 79, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (1) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Leevel_Collection_Collection, end) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&end, "end", NULL, 80, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (0) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Leevel_Collection_Collection, index) {
	...
	if (Z_TYPE_P(value) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&key, "array_search", NULL, 81, value, &_0$$4, &_1$$4);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Collection_Collection, slice) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("array_slice", NULL, 82, &_0, &_1, length);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Collection_Collection, map) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("array_column", NULL, 83, &_0, key, value);
	zephir_check_call_status();
	RETURN_MM();
