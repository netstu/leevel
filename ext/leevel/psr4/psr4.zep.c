...
ZEPHIR_INIT_CLASS(Leevel_Psr4_Psr4) {
	...
	ZEPHIR_REGISTER_CLASS(Leevel\\Psr4, Psr4, leevel, psr4_psr4, leevel_psr4_psr4_method_entry, 0);
	 ...
	 */
	zend_declare_property_null(leevel_psr4_psr4_ce, SL("composer"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(leevel_psr4_psr4_ce, SL("sandbox"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(leevel_psr4_psr4_ce, SL("namespaces"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(leevel_psr4_psr4_ce, SL("shortNamespace"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(leevel_psr4_psr4_ce TSRMLS_CC, 1, leevel_psr4_ipsr4_ce);
	return SUCCESS;
...
PHP_METHOD(Leevel_Psr4_Psr4, import) {
	...
	ZEPHIR_CALL_FUNCTION(&packagePath, "realpath", NULL, 103, &package);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Psr4_Psr4, namespaces) {
	...
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, &temp, 0, PH_NOISY | PH_READONLY, "leevel/psr4/psr4.zep", 124 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&path);
	ZEPHIR_CONCAT_VS(&path, &_1, "\\");
	if (!(zephir_array_isset(&prefix, &path))) {
		RETURN_MM_NULL();
	}
	zephir_array_fetch(&_2, &prefix, &path, PH_NOISY | PH_READONLY, "leevel/psr4/psr4.zep", 129 TSRMLS_CC);
	zephir_array_fetch_long(&_3, &_2, 0, PH_NOISY | PH_READONLY, "leevel/psr4/psr4.zep", 129 TSRMLS_CC);
...
PHP_METHOD(Leevel_Psr4_Psr4, autoload) {
	...
	zephir_array_fast_append(&namespaces, &_2);
	zephir_is_iterable(&namespaces, 0, "leevel/psr4/psr4.zep", 174);
...
PHP_METHOD(Leevel_Psr4_Psr4, shortNamespaceMap) {
	...
	if (_4) {
		...
		ZEPHIR_MAKE_REF(&tmp);
		ZEPHIR_CALL_FUNCTION(&definedClass, "array_pop", NULL, 104, &tmp);
		ZEPHIR_UNREF(&tmp);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&namespaces);
		...
		zephir_eval_php(&evals, &_6$$3, "/data/codes/queryyetsimple/leevel/psr4/psr4.zep:196" TSRMLS_CC);
	}
	ZEPHIR_MM_RESTORE();
