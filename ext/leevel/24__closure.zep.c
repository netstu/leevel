...
ZEPHIR_INIT_CLASS(leevel_24__closure) {

	ZEPHIR_REGISTER_CLASS(leevel, 24__closure, leevel, 24__closure, leevel_24__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	return SUCCESS;

}

PHP_METHOD(leevel_24__closure, __invoke) {
	...
	zephir_array_fast_append(&tmp, &_0);
	zephir_is_iterable(&tmp, 0, "leevel/router/provider/register.zep", 125);
	...
	if (!_5) {
	_5 = zephir_fetch_class_str_ex(SL("Leevel\\Router\\Router"), ZEND_FETCH_CLASS_AUTO);
	}
