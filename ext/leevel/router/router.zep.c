...
PHP_METHOD(Leevel_Router_Router, throughMiddleware) {
	...
	zephir_array_fetch(&_3, &_2, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 240 TSRMLS_CC);
	if (!(zephir_is_true(&_3))) {
		RETURN_MM_NULL();
	}
	zephir_read_property(&_4, this_ptr, SL("currentMiddlewares"), PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch(&_5, &_4, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 244 TSRMLS_CC);
	if (zephir_is_true(&_5)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &pipeline, "__construct", NULL, 127, &_6$$5);
		zephir_check_call_status();
		...
		zephir_array_fetch(&_14$$5, &_13$$5, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 253 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "call_user_func", &_9, 8, &_12$$5, &_14$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &pipeline, "then", NULL, 128);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Router_Router, addBasepaths) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_unique", NULL, 129, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Router_Router, matchePath) {
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		zephir_array_fetch_long(path, &tmpListPathQuery, 0, PH_NOISY, "leevel/router/router.zep", 445 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&query);
		zephir_array_fetch_long(&query, &tmpListPathQuery, 1, PH_NOISY, "leevel/router/router.zep", 446 TSRMLS_CC);
		if (zephir_is_true(&query)) {
			ZEPHIR_INIT_VAR(&_2$$4);
			zephir_fast_explode_str(&_2$$4, SL("&"), &query, LONG_MAX TSRMLS_CC);
			zephir_is_iterable(&_2$$4, 0, "leevel/router/router.zep", 453);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2$$4), _3$$4)
			{
				...
				zephir_array_fetch_long(&_5$$5, &item, 1, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 451 TSRMLS_CC);
				zephir_array_fetch_long(&_6$$5, &item, 0, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 451 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_is_iterable(&_7, 0, "leevel/router/router.zep", 466);
	...
	if (_14) {
		zephir_array_fetch_long(&_16, &paths, 0, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 470 TSRMLS_CC);
	...
	zephir_array_fetch_long(&paths, &tmpListPathsParams, 0, PH_NOISY, "leevel/router/router.zep", 475 TSRMLS_CC);
	ZEPHIR_OBS_VAR(&params);
	zephir_array_fetch_long(&params, &tmpListPathsParams, 1, PH_NOISY, "leevel/router/router.zep", 476 TSRMLS_CC);
	if (zephir_fast_count_int(&paths TSRMLS_CC) == 1) {
		ZEPHIR_MAKE_REF(&paths);
		ZEPHIR_CALL_FUNCTION(&_20$$9, "array_pop", &_21, 130, &paths);
		ZEPHIR_UNREF(&paths);
		zephir_check_call_status();
		...
		if (zephir_is_true(&paths)) {
			ZEPHIR_MAKE_REF(&paths);
			ZEPHIR_CALL_FUNCTION(&_22$$11, "array_pop", &_21, 130, &paths);
			ZEPHIR_UNREF(&paths);
			zephir_check_call_status();
		...
		if (zephir_is_true(&paths)) {
			ZEPHIR_MAKE_REF(&paths);
			ZEPHIR_CALL_FUNCTION(&_23$$12, "array_pop", &_21, 130, &paths);
			ZEPHIR_UNREF(&paths);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string(&result, SL("_params"))) {
		ZEPHIR_OBS_NVAR(&_26);
		zephir_array_fetch_string(&_26, &result, SL("_params"), PH_NOISY, "leevel/router/router.zep", 494 TSRMLS_CC);
	} else {
...
PHP_METHOD(Leevel_Router_Router, callStaticMacro) {
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_array_fetch(&_2$$3, &_1$$3, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 536 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_3, "leevel/router/router.zep", 539 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Router_Router, callMacro) {
	...
	if (zephir_is_true(&_0)) {
		zephir_read_static_property_ce(&_1$$3, leevel_router_router_ce, SL("macro"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_VAR(&_2$$3);
		zephir_array_fetch(&_2$$3, &_1$$3, &method, PH_NOISY, "leevel/router/router.zep", 555 TSRMLS_CC);
		if (zephir_instance_of_ev(&_2$$3, zend_ce_closure TSRMLS_CC)) {
			...
			zephir_array_fetch(&_4$$4, &_3$$4, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 556 TSRMLS_CC);
			...
			zephir_array_fetch(&_7$$5, &_6$$5, &method, PH_NOISY | PH_READONLY, "leevel/router/router.zep", 558 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_8, "leevel/router/router.zep", 562 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Router_Router, normalizePrefix) {
	...
	ZEPHIR_INIT_VAR(&result);
	array_init(&result);
	zephir_is_iterable(&paths, 0, "leevel/router/router.zep", 587);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&paths), _0)
	{
		...
		zephir_array_append(&result, &item, PH_SEPARATE, "leevel/router/router.zep", 584);
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&item);
	RETURN_CTOR(&result);
...
PHP_METHOD(Leevel_Router_Router, normalizePathsAndParams) {
	...
	array_init(&params);
	k = 0;
	zephir_is_iterable(&data, 0, "leevel/router/router.zep", 624);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&data), _0)
	{
		...
		if (zephir_is_numeric(&item)) {
			...
			zephir_array_append(&paths, &item, PH_SEPARATE, "leevel/router/router.zep", 620);
		}
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&item);
...
PHP_METHOD(Leevel_Router_Router, parseDefaultBind) {
	...
	if (zephir_instance_of_ev(&controller, leevel_mvc_icontroller_ce TSRMLS_CC)) {
		...
		ZEPHIR_INIT_VAR(&_8$$6);
		ZVAL_STRING(&_8$$6, "Leevel\\Mvc\\IView");
...
PHP_METHOD(Leevel_Router_Router, parseMiddleware) {
	...
	zephir_array_fetch_string(&_2, &_1, SL("handle"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 925 TSRMLS_CC);
	zephir_array_fetch_string(&_3, &matchedMiddlewares, SL("handle"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 925 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_5, &_4, SL("terminate"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 926 TSRMLS_CC);
	zephir_array_fetch_string(&_6, &matchedMiddlewares, SL("terminate"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 926 TSRMLS_CC);
...
PHP_METHOD(Leevel_Router_Router, matchedApp) {
	...
	if (zephir_is_true(&_0)) {
		...
		if (zephir_is_true(&_3$$4)) {
			...
			ZEPHIR_OBS_NVAR(&app);
			zephir_array_fetch_string(&app, &_4$$6, SL("_app"), PH_NOISY, "leevel/router/router.zep", 947 TSRMLS_CC);
			zephir_read_property(&_5$$6, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch_string(&_6$$6, &_5$$6, SL("_app"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 948 TSRMLS_CC);
...
PHP_METHOD(Leevel_Router_Router, matchedController) {
	...
	if (zephir_is_true(&_0)) {
		...
		if (zephir_is_true(&_3$$4)) {
			...
			zephir_read_property(&_4$$6, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_OBS_NVAR(&controller);
			zephir_array_fetch_string(&controller, &_4$$6, SL("_c"), PH_NOISY, "leevel/router/router.zep", 972 TSRMLS_CC);
		}
	}
...
PHP_METHOD(Leevel_Router_Router, matchedAction) {
	...
	if (zephir_is_true(&_0)) {
		...
		if (zephir_is_true(&_3$$4)) {
			...
			zephir_read_property(&_4$$6, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_OBS_NVAR(&action);
			zephir_array_fetch_string(&action, &_4$$6, SL("_a"), PH_NOISY, "leevel/router/router.zep", 996 TSRMLS_CC);
		}
	}
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "-");
...
PHP_METHOD(Leevel_Router_Router, matchedPrefix) {
	...
	zephir_read_property(&_0, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch_string(&_1, &_0, SL("_prefix"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 1019 TSRMLS_CC);
	RETURN_CTORW(&_1);
...
PHP_METHOD(Leevel_Router_Router, matchedParams) {
	...
	zephir_array_fetch_string(&_2, &_1, SL("_params"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 1029 TSRMLS_CC);
	if (!(Z_TYPE_P(&_2) == IS_NULL)) {
		zephir_read_property(&_3, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_0, &_3, SL("_params"), PH_NOISY, "leevel/router/router.zep", 1029 TSRMLS_CC);
	} else {
		array_init(&_0);
	}
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Leevel_Router_Router, matchedMiddlewares) {
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property(&_1, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch_string(&_2, &_1, SL("_middlewares"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 1039 TSRMLS_CC);
	if (!(Z_TYPE_P(&_2) == IS_NULL)) {
		zephir_read_property(&_3, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_0, &_3, SL("_middlewares"), PH_NOISY, "leevel/router/router.zep", 1039 TSRMLS_CC);
	} else {
...
PHP_METHOD(Leevel_Router_Router, matchedVars) {
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property(&_1, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch_string(&_2, &_1, SL("_vars"), PH_NOISY | PH_READONLY, "leevel/router/router.zep", 1052 TSRMLS_CC);
	if (!(Z_TYPE_P(&_2) == IS_NULL)) {
		zephir_read_property(&_3, this_ptr, SL("matchedData"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_0, &_3, SL("_vars"), PH_NOISY, "leevel/router/router.zep", 1052 TSRMLS_CC);
	} else {
		array_init(&_0);
	}
	RETURN_CCTOR(&_0);
