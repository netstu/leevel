...
ZEPHIR_INIT_CLASS(Leevel_Router_Url) {
	 ...
	 * @var array
	 */
	zend_declare_property_null(leevel_router_url_ce, SL("parseMvc"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(leevel_router_url_ce, SL("httpPrefix"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(leevel_router_url_ce, SL("httpSuffix"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(leevel_router_url_ce, SL("makeOption"), ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	zend_class_implements(leevel_router_url_ce TSRMLS_CC, 1, leevel_option_iclass_ce);
	return SUCCESS;
...
PHP_METHOD(Leevel_Router_Url, make) {
	...
	zephir_array_fetch_string(&_4, &option, SL("normal"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 122 TSRMLS_CC);
	...
	if (zephir_is_true(&_3)) {
		...
		zephir_array_fetch_string(&_6$$3, &option, SL("suffix"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 129 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_8$$3, &_7$$3, SL("params"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 131 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_13$$7, &option, SL("normal"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 135 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&result, this_ptr, "normalurl", NULL, 0, &_13$$7);
		zephir_check_call_status();
	}
	zephir_array_fetch_string(&_15, &option, SL("subdomain"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 138 TSRMLS_CC);
...
PHP_METHOD(Leevel_Router_Url, option) {
	...
	if (!(Z_TYPE_P(&name) == IS_STRING)) {
		...
		if (!_1$$3) {
		_1$$3 = zephir_fetch_class_str_ex(SL("Leevel\\Router\\InvalidArgumentException"), ZEND_FETCH_CLASS_AUTO);
		}
		...
		zephir_throw_exception_debug(&_0$$3, "leevel/router/url.zep", 163 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Leevel_Router_Url, options) {
	...
	zephir_is_iterable(&option, 0, "leevel/router/url.zep", 202);
...
PHP_METHOD(Leevel_Router_Url, getOption) {
	...
	if (zephir_array_isset(&_1, &name)) {
		...
		zephir_array_fetch(&_0, &_2, &name, PH_NOISY, "leevel/router/url.zep", 214 TSRMLS_CC);
	} else {
...
PHP_METHOD(Leevel_Router_Url, deleteOptions) {
	...
	zephir_is_iterable(&option, 0, "leevel/router/url.zep", 265);
...
PHP_METHOD(Leevel_Router_Url, pathinfoUrl) {
	...
	if (!(zephir_is_true(&_2))) {
		...
		zephir_array_fetch_string(&_6, &_5, SL("app"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 277 TSRMLS_CC);
		ZEPHIR_INIT_NVAR(&_1);
	...
	zephir_array_fetch_string(&_8, &_7, SL("prefix"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 279 TSRMLS_CC);
	if (zephir_is_true(&_8)) {
		ZEPHIR_INIT_VAR(&_9$$3);
		zephir_read_property(&_10$$3, this_ptr, SL("parseMvc"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_11$$3, &_10$$3, SL("prefix"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 280 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_15$$3, &_14$$3, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 280 TSRMLS_CC);
	...
	if (_19) {
		...
		zephir_array_fetch_string(&_22$$4, &_21$$4, SL("controller"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 284 TSRMLS_CC);
	...
	if (!(zephir_is_true(&_23))) {
		...
		zephir_array_fetch_string(&_25$$5, &_24$$5, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 288 TSRMLS_CC);
...
PHP_METHOD(Leevel_Router_Url, customUrl) {
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_7)) {
		...
		zephir_array_fetch_long(&result, &tmp, 0, PH_NOISY, "leevel/router/url.zep", 312 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_10$$5, &_9$$5, SL("params"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 317 TSRMLS_CC);
		zephir_is_iterable(&_10$$5, 0, "leevel/router/url.zep", 321);
...
PHP_METHOD(Leevel_Router_Url, matchVar) {
	...
	zephir_array_fetch_string(&params, &_0, SL("params"), PH_NOISY, "leevel/router/url.zep", 336 TSRMLS_CC);
	zephir_array_fetch_long(&key, matchs, 1, PH_NOISY | PH_READONLY, "leevel/router/url.zep", 337 TSRMLS_CC);
	zephir_array_fetch_long(&_1, matchs, 1, PH_READONLY, "leevel/router/url.zep", 339 TSRMLS_CC);
	if (zephir_array_isset(&params, &_1)) {
		ZEPHIR_OBS_VAR(&result);
		zephir_array_fetch(&result, &params, &key, PH_NOISY, "leevel/router/url.zep", 340 TSRMLS_CC);
		zephir_array_unset(&params, &key, PH_SEPARATE);
	} else {
		ZEPHIR_OBS_NVAR(&result);
		zephir_array_fetch_long(&result, matchs, 0, PH_NOISY, "leevel/router/url.zep", 343 TSRMLS_CC);
	}
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Leevel_Router_Url, normalUrl) {
	...
	if (!(zephir_is_true(&_6))) {
		...
		zephir_array_fetch_string(&_8$$4, &_7$$4, SL("controller"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 368 TSRMLS_CC);
	...
	if (!(zephir_is_true(&_9))) {
		...
		zephir_array_fetch_string(&_11$$5, &_10$$5, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 372 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_13, &_12, SL("prefix"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 375 TSRMLS_CC);
	if (zephir_is_true(&_13)) {
		zephir_read_property(&_14$$6, this_ptr, SL("parseMvc"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch_string(&_15$$6, &_14$$6, SL("prefix"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 376 TSRMLS_CC);
	...
	zephir_array_fetch_string(&params, &_16, SL("params"), PH_NOISY, "leevel/router/url.zep", 379 TSRMLS_CC);
	zephir_is_iterable(&params, 0, "leevel/router/url.zep", 385);
...
PHP_METHOD(Leevel_Router_Url, parseMvc) {
	...
	if (zephir_array_isset_string(&parse, SL("scheme"))) {
		ZEPHIR_OBS_NVAR(&_11);
		zephir_array_fetch_string(&_11, &parse, SL("scheme"), PH_NOISY, "leevel/router/url.zep", 439 TSRMLS_CC);
	} else {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&mvc), _14, _15, _13)
	{
		...
		if (zephir_array_isset(&params, &key)) {
			zephir_array_fetch(&_16$$9, &params, &key, PH_NOISY | PH_READONLY, "leevel/router/url.zep", 449 TSRMLS_CC);
	...
	if (zephir_array_isset_string(&parse, SL("path"))) {
		zephir_array_fetch_string(&_17$$10, &result, SL("controller"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 455 TSRMLS_CC);
		if (!(zephir_is_true(&_17$$10))) {
			ZEPHIR_INIT_VAR(&_18$$11);
			if (zephir_array_isset_string(&parse, SL("host"))) {
				ZEPHIR_OBS_NVAR(&_18$$11);
				zephir_array_fetch_string(&_18$$11, &parse, SL("host"), PH_NOISY, "leevel/router/url.zep", 456 TSRMLS_CC);
			} else {
		...
		zephir_array_fetch_string(&_20$$10, &result, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 459 TSRMLS_CC);
		if (!(zephir_is_true(&_20$$10))) {
			zephir_array_fetch_string(&_21$$12, &parse, SL("path"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 460 TSRMLS_CC);
			ZVAL_LONG(&_22$$12, 1);
		...
		zephir_array_fetch_string(&_24$$13, &result, SL("controller"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 463 TSRMLS_CC);
		if (!(zephir_is_true(&_24$$13))) {
			ZEPHIR_INIT_VAR(&_25$$14);
			if (zephir_array_isset_string(&parse, SL("host"))) {
				ZEPHIR_OBS_NVAR(&_25$$14);
				zephir_array_fetch_string(&_25$$14, &parse, SL("host"), PH_NOISY, "leevel/router/url.zep", 464 TSRMLS_CC);
			} else {
		...
		zephir_array_fetch_string(&_27$$13, &result, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 467 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_30, &result, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 472 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "/");
	ZEPHIR_INIT_VAR(&_31);
	zephir_fast_strpos(&_31, &_30, &_0, 0 );
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_31)) {
		zephir_array_fetch_string(&_32$$16, &result, SL("action"), PH_NOISY | PH_READONLY, "leevel/router/url.zep", 473 TSRMLS_CC);
...
PHP_METHOD(Leevel_Router_Url, equalDefault) {
	...
	zephir_array_fetch(&_3, &_2, &type, PH_NOISY | PH_READONLY, "leevel/router/url.zep", 566 TSRMLS_CC);
