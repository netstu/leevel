...
PHP_METHOD(Leevel_Router_ResponseFactory, download) {
	...
	ZEPHIR_CALL_METHOD(NULL, &response, "__construct", NULL, 90, file, &_0, &headers, &_1, &_2, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Router_ResponseFactory, file) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 90, file, &_0, &headers, &_1, &_2, &_3);
	zephir_check_call_status();
	RETURN_MM();
