...
PHP_METHOD(Leevel_Router_RouterProvider, importCachedRouters) {
	...
	zephir_array_fetch_string(&_3, &routers, SL("middlewares"), PH_NOISY | PH_READONLY, "leevel/router/routerprovider.zep", 112 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setglobalmiddlewares", NULL, 0, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Router_RouterProvider, loadRouters) {
	...
	zval routers, middlewares, _0, _1;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&middlewares, this_ptr, "getmiddlewares", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "makemiddlewareparser", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, &_0, "handle", NULL, 0, &middlewares);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&middlewares, &_1);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setglobalmiddlewares", NULL, 0, &middlewares);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setroutersdata", NULL, 0, &routers);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Router_RouterProvider, setRoutersData) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_2, &routers, SL("basepaths"), PH_NOISY | PH_READONLY, "leevel/router/routerprovider.zep", 168 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &router, "setbasepaths", NULL, 0, &_2);
	zephir_check_call_status();
	zephir_array_fetch_string(&_3, &routers, SL("groups"), PH_NOISY | PH_READONLY, "leevel/router/routerprovider.zep", 170 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &router, "setgroups", NULL, 0, &_3);
	zephir_check_call_status();
	zephir_array_fetch_string(&_4, &routers, SL("routers"), PH_NOISY | PH_READONLY, "leevel/router/routerprovider.zep", 172 TSRMLS_CC);
