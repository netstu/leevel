...
PHP_METHOD(Leevel_Router_Provider_Register, urlClosure) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 123, &request, &options);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Router_Provider_Register, responseClosure) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &response, "__construct", NULL, 124, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "view\\action_success");
	ZEPHIR_CALL_METHOD(&_4, &option, "get", NULL, 0, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, &response, "setviewsuccesstemplate", NULL, 125, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
