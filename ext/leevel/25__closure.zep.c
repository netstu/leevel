...
ZEPHIR_INIT_CLASS(leevel_25__closure) {
	...
	ZEPHIR_REGISTER_CLASS(leevel, 25__closure, leevel, 25__closure, leevel_25__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(leevel_25__closure, __invoke) {
	...
	zephir_array_fast_append(&tmp, &_0);
	zephir_is_iterable(&tmp, 0, "leevel/router/provider/register.zep", 157);
