...
ZEPHIR_INIT_CLASS(leevel_3__closure) {
	...
	ZEPHIR_REGISTER_CLASS(leevel, 3__closure, leevel, 3__closure, leevel_3__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(leevel_3__closure, __invoke) {
	...
	ZEPHIR_CALL_FUNCTION(&hash, "spl_object_hash", NULL, 138, &closures);
