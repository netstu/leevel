...
PHP_METHOD(Leevel_Http_Request, createFromGlobals) {
	...
	array_init(&_0);
	ZVAL_NULL(&_1);
	ZEPHIR_CALL_METHOD(NULL, &request, "__construct", NULL, 97, _GET, _POST, &_0, _COOKIE, _FILES, _SERVER, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Http_Request, normalizeRequestFromContent) {
	...
	if (_6) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 98, &_7$$3, &data);
		ZEPHIR_UNREF(&data);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_8$$3);
		object_init_ex(&_8$$3, leevel_http_bag_ce);
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 95, &data);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Http_Request, all) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("array_replace_recursive", NULL, 99, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Http_Request, getContent) {
	...
	if (zephir_is_true(&resources)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "rewind", NULL, 100, &_1$$3);
		zephir_check_call_status();
		zephir_read_property(&_2$$3, this_ptr, SL("content"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_RETURN_CALL_FUNCTION("stream_get_contents", NULL, 101, &_2$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Leevel_Http_Request, getBaseUrl) {
	...
	if (ZEPHIR_IS_IDENTICAL(&_3, &fileName)) {
		...
		ZEPHIR_CALL_FUNCTION(&_23$$7, "array_reverse", NULL, 102, &segs);
		zephir_check_call_status();
	...
	if (!(_41)) {
		ZEPHIR_CALL_FUNCTION(&_29, "rawurldecode", NULL, 103, &requestUri);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_13);
...
PHP_METHOD(Leevel_Http_Request, callStaticMacro) {
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_array_fetch(&_2$$3, &_1$$3, &method, PH_NOISY | PH_READONLY, "leevel/http/request.zep", 1650 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_3, "leevel/http/request.zep", 1653 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Http_Request, callMacro) {
	...
	if (zephir_is_true(&_0)) {
		zephir_read_static_property_ce(&_1$$3, leevel_http_request_ce, SL("macro"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_VAR(&_2$$3);
		zephir_array_fetch(&_2$$3, &_1$$3, &method, PH_NOISY, "leevel/http/request.zep", 1669 TSRMLS_CC);
		if (zephir_is_instance_of(&_2$$3, SL("Leevel\\Http\\Closure") TSRMLS_CC)) {
			...
			zephir_array_fetch(&_4$$4, &_3$$4, &method, PH_NOISY | PH_READONLY, "leevel/http/request.zep", 1670 TSRMLS_CC);
			...
			zephir_array_fetch(&_7$$5, &_6$$5, &method, PH_NOISY | PH_READONLY, "leevel/http/request.zep", 1672 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_8, "leevel/http/request.zep", 1676 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Http_Request, normalizeQueryString) {
	...
	zephir_is_iterable(&_0, 0, "leevel/http/request.zep", 1740);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		zephir_array_append(&parts, &item, PH_SEPARATE, "leevel/http/request.zep", 1737);
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&item);
...
PHP_METHOD(Leevel_Http_Request, getUrlencodedPrefix) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "rawurldecode", NULL, 103, &strings);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	...
	if (zephir_is_true(&_2)) {
		zephir_array_fetch_long(&_5$$4, &matches, 0, PH_NOISY | PH_READONLY, "leevel/http/request.zep", 1787 TSRMLS_CC);
		RETURN_CTOR(&_5$$4);
	}
	RETURN_MM_BOOL(0);
