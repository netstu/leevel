...
PHP_METHOD(Leevel_Http_JsonResponse, __construct) {
	...
	if (Z_TYPE_P(data) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, data, "__construct", NULL, 40);
		zephir_check_call_status();
	}
	if (json) {
...
PHP_METHOD(Leevel_Http_JsonResponse, create) {
	...
	ZVAL_LONG(&_0, status);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 41, data, &_0, &headers);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Http_JsonResponse, fromJsonString) {
	...
	ZVAL_LONG(&_0, status);
	ZVAL_BOOL(&_1, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 41, data, &_0, &headers, &_1);
	zephir_check_call_status();
	RETURN_MM();
