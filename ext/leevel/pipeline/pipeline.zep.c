...
PHP_METHOD(Leevel_Pipeline_Pipeline, traverseGenerator) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 70, &args, &next);
	ZEPHIR_UNREF(&args);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Pipeline_Pipeline, stageGenerator) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 70, &stage, &_0);
	ZEPHIR_UNREF(&stage);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Pipeline_Pipeline, parse) {
	...
	array_init(&_1);
	ZVAL_LONG(&_2, 2);
	ZEPHIR_CALL_FUNCTION(&temp, "array_pad", NULL, 116, &_0, &_2, &_1);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&name);
