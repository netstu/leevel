...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_cookie_icookie_arrays, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, keys)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_cookie_icookie_arraysdelete, 0, 0, 2)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, keys)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_cookie_icookie_method_entry) {
	...
	PHP_ABSTRACT_ME(Leevel_Cookie_ICookie, arrays, arginfo_leevel_cookie_icookie_arrays)
	PHP_ABSTRACT_ME(Leevel_Cookie_ICookie, arraysDelete, arginfo_leevel_cookie_icookie_arraysdelete)
