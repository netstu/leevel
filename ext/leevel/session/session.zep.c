...
PHP_METHOD(Leevel_Session_Session, start) {
	...
	if (_30) {
		...
		ZEPHIR_CALL_FUNCTION(&_32, "session_set_save_handler", NULL, 129, &_31);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_38, "session_start", NULL, 130);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, pause) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstart", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "session_write_close", NULL, 131);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, destroy) {
	...
	if (zephir_array_isset(_COOKIE, &name)) {
		...
		ZVAL_STRING(&_4$$3, "/");
		ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 132, &name, &_2$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(NULL, "session_destroy", NULL, 133);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 134);
	zephir_check_call_status();
	do {
...
PHP_METHOD(Leevel_Session_Session, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 135, &name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 135);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 136, &id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 136);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, regenerateId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 137, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Leevel_Session_Session, setSavePath) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_save_path", NULL, 138, &savepath);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getSavePath) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_save_path", NULL, 138);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, getCookieDomain) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "session.cookie_domain");
	ZEPHIR_CALL_FUNCTION(&result, "ini_get", NULL, 112, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&result);
...
PHP_METHOD(Leevel_Session_Session, setCacheLimiter) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_cache_limiter", NULL, 139, &limiter);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getCacheLimiter) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_cache_limiter", NULL, 139);
	zephir_check_call_status();
	RETURN_MM();
