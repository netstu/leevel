...
PHP_METHOD(Leevel_Session_Session, start) {
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "0");
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 53, &_5, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_5);
	ZVAL_STRING(&_5, "id");
	...
	if (_30) {
		...
		ZEPHIR_CALL_FUNCTION(&_32, "session_set_save_handler", NULL, 122, &_31);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_38, "session_start", NULL, 123);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, merge) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "array_unique", NULL, 65, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, pop) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "array_diff", NULL, 66, &_0, &value);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, pause) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstart", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "session_write_close", NULL, 124);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, destroy) {
	...
	if (zephir_array_isset(_COOKIE, &name)) {
		...
		ZVAL_STRING(&_4$$3, "/");
		ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 125, &name, &_2$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(NULL, "session_destroy", NULL, 126);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 127);
	zephir_check_call_status();
	do {
...
PHP_METHOD(Leevel_Session_Session, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 128, &name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 128);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 129, &id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 129);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, regenerateId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 130, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Leevel_Session_Session, setSavePath) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_save_path", NULL, 131, &savepath);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getSavePath) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_save_path", NULL, 131);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, setCookieDomain) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 53, &_0, &domain);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getCookieDomain) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "session.cookie_domain");
	ZEPHIR_CALL_FUNCTION(&result, "ini_get", NULL, 105, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&result);
...
PHP_METHOD(Leevel_Session_Session, setCacheExpire) {
	...
	ZVAL_LONG(&_0, second);
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", &_3, 53, &_2, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Leevel_Session_Session, setUseCookies) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "1");
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", &_2, 53, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Leevel_Session_Session, setCacheLimiter) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_cache_limiter", NULL, 132, &limiter);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getCacheLimiter) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_cache_limiter", NULL, 132);
	zephir_check_call_status();
	RETURN_MM();
