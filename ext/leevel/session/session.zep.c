...
PHP_METHOD(Leevel_Session_Session, start) {
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "0");
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 67, &_5, &_6);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, setCookieDomain) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 67, &_0, &domain);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, setCacheExpire) {
	...
	ZVAL_LONG(&_0, second);
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", &_3, 67, &_2, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Leevel_Session_Session, setUseCookies) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "1");
	ZEPHIR_CALL_FUNCTION(NULL, "ini_set", &_2, 67, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Leevel_Session_Session, setGcProbability) {
	...
	if (_2) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 67, &_3$$3, &_4$$3);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
