...
PHP_METHOD(Leevel_Session_Session, start) {
	...
	if (_30) {
		...
		ZEPHIR_CALL_FUNCTION(&_32, "session_set_save_handler", NULL, 128, &_31);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_38, "session_start", NULL, 129);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, merge) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "array_unique", NULL, 83, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, pop) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "array_diff", NULL, 84, &_0, &value);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Session_Session, pause) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstart", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "session_write_close", NULL, 130);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, destroy) {
	...
	if (zephir_array_isset(_COOKIE, &name)) {
		...
		ZVAL_STRING(&_4$$3, "/");
		ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 131, &name, &_2$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(NULL, "session_destroy", NULL, 132);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 133);
	zephir_check_call_status();
	do {
...
PHP_METHOD(Leevel_Session_Session, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 134, &name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 134);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 135, &id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 135);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, regenerateId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 136, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Leevel_Session_Session, setSavePath) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_save_path", NULL, 137, &savepath);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getSavePath) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_save_path", NULL, 137);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Session_Session, setCacheLimiter) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_cache_limiter", NULL, 138, &limiter);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Session_Session, getCacheLimiter) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_cache_limiter", NULL, 138);
	zephir_check_call_status();
	RETURN_MM();
