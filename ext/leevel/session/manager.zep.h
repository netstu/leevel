...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_session_manager_getoptionconnect, 0, 0, 1)
	ZEND_ARG_INFO(0, connect)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(leevel_session_manager_method_entry) {
	PHP_ME(Leevel_Session_Manager, getOptionNamespace, NULL, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Leevel_Session_Manager, getOptionConnect, arginfo_leevel_session_manager_getoptionconnect, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
