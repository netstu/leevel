...
PHP_METHOD(Leevel_Session_Provider_Register, sessions) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, leevel_29__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Leevel_Session_Provider_Register, session) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, leevel_30__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Leevel_Session_Provider_Register, middleware) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "Leevel\\Session\\Middleware\\Session");
