...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_bootstrap_bootstrap_loadoption_handle, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(leevel_bootstrap_bootstrap_loadoption_method_entry) {
	PHP_ME(Leevel_Bootstrap_Bootstrap_LoadOption, handle, arginfo_leevel_bootstrap_bootstrap_loadoption_handle, ZEND_ACC_PUBLIC)
