...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, handle) {
	...
	if (!test) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_reporting", NULL, 61, &_0$$3);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 47, &_1$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 62, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "register_shutdown_function", NULL, 63, &_4$$3);
		zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING_IDENTICAL(&_5$$3, "production")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 64, &_6$$4, &_7$$4);
			zephir_check_call_status();
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, setErrorHandle) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "error_reporting", NULL, 61);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 0);
	ZVAL_LONG(&_3, code);
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 65, &description, &_2, &_3, file, line);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, registerShutdownFunction) {
	...
	ZEPHIR_CALL_FUNCTION(&error, "error_get_last", NULL, 66);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, setExceptionHandler) {
	...
	if (!(zephir_instance_of_ev(e, zend_exception_get_default(TSRMLS_C) TSRMLS_CC))) {
		...
		zephir_check_call_status();
		ZVAL_LONG(&_5$$3, 1);
		ZEPHIR_CALL_METHOD(NULL, &fatalException, "__construct", NULL, 65, &_0$$3, &_1$$3, &_5$$3, &_2$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Leevel_Bootstrap_Bootstrap_RegisterRuntime, formatErrorException) {
	...
	ZVAL_LONG(&_4, 0);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 65, &_0, &_1, &_4, &_2, &_3);
	zephir_check_call_status();
	RETURN_MM();
