...
PHP_METHOD(Leevel_View_Connect, deleteVar) {
	...
	if (ZEPHIR_IS_EMPTY(&args)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_BadMethodCallException, "Wrong number of parameters", "leevel/view/connect.zep", 113);
		return;
	}
	ZEPHIR_OBS_VAR(&_0);
	zephir_array_fetch_long(&_0, &args, 0, PH_NOISY, "leevel/view/connect.zep", 116 TSRMLS_CC);
...
PHP_METHOD(Leevel_View_Connect, parseFile) {
	...
	ZVAL_LONG(&_3, 4);
	ZEPHIR_CALL_FUNCTION(&_4, "pathinfo", NULL, 56, &tpl, &_3);
	zephir_check_call_status();
	...
	if (_8) {
		...
		zephir_array_fetch_string(&_12$$4, &_11$$4, SL("theme_path"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 184 TSRMLS_CC);
		if (!(zephir_is_true(&_12$$4))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_RuntimeException, "Theme path must be set", "leevel/view/connect.zep", 185);
			return;
		}
		if (ZEPHIR_IS_STRING(&tpl, "")) {
			zephir_read_property(&_13$$6, this_ptr, SL("option"), PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch_string(&_14$$6, &_13$$6, SL("controller_name"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 190 TSRMLS_CC);
			zephir_read_property(&_15$$6, this_ptr, SL("option"), PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch_string(&_16$$6, &_15$$6, SL("controlleraction_depr"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 191 TSRMLS_CC);
			zephir_read_property(&_17$$6, this_ptr, SL("option"), PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch_string(&_18$$6, &_17$$6, SL("action_name"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 192 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_27$$4, &_26$$4, SL("controlleraction_depr"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 207 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_29$$4, &_28$$4, SL("theme_path"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 209 TSRMLS_CC);
		...
		if (zephir_is_true(&theme)) {
			...
			zephir_array_fetch_string(&_33$$9, &_32$$9, SL("theme_name"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 213 TSRMLS_CC);
		...
		if (!(ZEPHIR_IS_EMPTY(&ext))) {
			...
			zephir_array_fetch_string(&_36$$11, &_35$$11, SL("suffix"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 221 TSRMLS_CC);
...
PHP_METHOD(Leevel_View_Connect, parseDefaultFile) {
	...
	zephir_array_fetch_string(&_3, &_2, SL("theme_path"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 259 TSRMLS_CC);
	if (!(zephir_is_true(&_3))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_RuntimeException, "Theme path must be set", "leevel/view/connect.zep", 260);
		return;
	}
	...
	if (_9) {
		...
		zephir_array_fetch_string(&_14$$5, &_13$$5, SL("theme_path"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 273 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_25, &_24, SL("theme_path_default"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 283 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_29, &_28, SL("theme_path"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 288 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_32, &_31, SL("theme_name"), PH_NOISY | PH_READONLY, "leevel/view/connect.zep", 290 TSRMLS_CC);
