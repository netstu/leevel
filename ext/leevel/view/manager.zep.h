...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_manager_makeconnectv8, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, options, 1)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(leevel_view_manager_method_entry) {
	PHP_ME(Leevel_View_Manager, getOptionNamespace, NULL, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Leevel_View_Manager, makeConnectV8, arginfo_leevel_view_manager_makeconnectv8, ZEND_ACC_PROTECTED)
