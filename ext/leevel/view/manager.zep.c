...
PHP_METHOD(Leevel_View_Manager, createConnect) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 127, connect);
...
PHP_METHOD(Leevel_View_Manager, makeConnectHtml) {
	...
	ZEPHIR_CALL_METHOD(NULL, &html, "__construct", NULL, 128, &options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &html, "setparseresolver", NULL, 129, &parser);
	zephir_check_call_status();
	RETURN_CCTOR(&html);
