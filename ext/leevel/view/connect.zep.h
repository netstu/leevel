...
ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_option, 0, 0, 2)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_optionarray, 0, 0, 2)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_ARRAY_INFO(0, value, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_options, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_getoption, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
	ZEND_ARG_INFO(0, defaults)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_getoptions, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_deleteoption, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_leevel_view_connect_deleteoptions, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(leevel_view_connect_method_entry) {
	...
	PHP_ME(Leevel_View_Connect, option, arginfo_leevel_view_connect_option, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, optionArray, arginfo_leevel_view_connect_optionarray, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, options, arginfo_leevel_view_connect_options, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, getOption, arginfo_leevel_view_connect_getoption, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, getOptions, arginfo_leevel_view_connect_getoptions, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, deleteOption, arginfo_leevel_view_connect_deleteoption, ZEND_ACC_PUBLIC)
	PHP_ME(Leevel_View_Connect, deleteOptions, arginfo_leevel_view_connect_deleteoptions, ZEND_ACC_PUBLIC)
