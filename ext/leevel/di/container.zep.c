...
PHP_METHOD(Leevel_Di_Container, alias) {
	...
	if (Z_TYPE_P(alias) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(alias), _1$$3, _2$$3, _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "alias", &_3, 70, &key, &item);
			zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, make) {
	...
	if (_8) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 71, &args, this_ptr);
		ZEPHIR_UNREF(&args);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseClosureReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 72, injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 73);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseMethodReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 74, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 75);
	zephir_check_call_status();
	if (ZEPHIR_IS_EMPTY(&param)) {
		ZEPHIR_INIT_NVAR(&param);
		array_init(&param);
...
PHP_METHOD(Leevel_Di_Container, parseClassReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 76, &injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &reflection, "isinstantiable", NULL, 77);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&constructor, &reflection, "getconstructor", NULL, 78);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, newInstanceArgs) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 76, classname);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_RETURN_CALL_METHOD(&_0$$3, "newinstanceargs", NULL, 79, args);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM();
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(&_1, zephir_get_internal_ce(SL("reflectionexception")) TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$4, "__construct", NULL, 76, classname);
			zephir_check_call_status();
			ZEPHIR_RETURN_CALL_METHOD(&_3$$4, "newinstancewithoutconstructor", NULL, 80);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
