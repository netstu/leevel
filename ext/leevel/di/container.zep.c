...
PHP_METHOD(Leevel_Di_Container, shareClosure) {
	...
	ZEPHIR_CALL_FUNCTION(&hash, "spl_object_hash", NULL, 31, &_0);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&obj);
...
PHP_METHOD(Leevel_Di_Container, alias) {
	...
	if (Z_TYPE_P(alias) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(alias), _1$$3, _2$$3, _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "alias", &_3, 32, &key, &item);
			zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, make) {
	...
	if (_8) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 33, &args, this_ptr);
		ZEPHIR_UNREF(&args);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseInjection) {
	...
	ZEPHIR_INIT_NVAR(&item);
	if (!(ZEPHIR_IS_EMPTY(&args))) {
		ZEPHIR_CALL_FUNCTION(&_14$$14, "array_values", NULL, 34, &result);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseClosureReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 35, injection);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseMethodReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 37, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseClassReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 39, &injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &reflection, "isinstantiable", NULL, 40);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&constructor, &reflection, "getconstructor", NULL, 41);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, newInstanceArgs) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 39, classname);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(&_0, "newinstanceargs", NULL, 42, args);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Di_Container, parseAlias) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "key", NULL, 43, &name);
	zephir_check_call_status();
