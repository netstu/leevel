...
PHP_METHOD(Leevel_Di_Container, shareClosure) {
	...
	ZEPHIR_CALL_FUNCTION(&hash, "spl_object_hash", NULL, 26, &_0);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&obj);
...
PHP_METHOD(Leevel_Di_Container, alias) {
	...
	if (Z_TYPE_P(alias) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(alias), _1$$3, _2$$3, _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "alias", &_3, 27, &key, &item);
			zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, make) {
	...
	if (_8) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 28, &args, this_ptr);
		ZEPHIR_UNREF(&args);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseInjection) {
	...
	ZEPHIR_INIT_NVAR(&item);
	if (!(ZEPHIR_IS_EMPTY(&args))) {
		ZEPHIR_CALL_FUNCTION(&_14$$14, "array_values", NULL, 29, &result);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseClosureReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 30, injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 31);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseMethodReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 32, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 33);
	zephir_check_call_status();
	if (ZEPHIR_IS_EMPTY(&param)) {
		ZEPHIR_INIT_NVAR(&param);
		array_init(&param);
...
PHP_METHOD(Leevel_Di_Container, parseClassReflection) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &reflection, "isinstantiable", NULL, 35);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&constructor, &reflection, "getconstructor", NULL, 36);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, newInstanceArgs) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 34, classname);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(&_0, "newinstanceargs", NULL, 37, args);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Leevel_Di_Container, parseAlias) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "key", NULL, 38, &name);
	zephir_check_call_status();
	zephir_array_fast_append(return_value, &_0);
	ZEPHIR_CALL_FUNCTION(&_0, "current", NULL, 39, &name);
	zephir_check_call_status();
	zephir_array_fast_append(return_value, &_0);
	RETURN_MM();
