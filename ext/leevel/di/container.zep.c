...
PHP_METHOD(Leevel_Di_Container, shareClosure) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *container, container_sub, hash, obj, _0, _1, _3, _2$$3;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_FUNCTION(&hash, "spl_object_hash", NULL, 68, &_0);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&obj);
	...
	if (zephir_array_isset_fetch(&obj, &_1, &hash, 0 TSRMLS_CC)) {
		...
		ZVAL_STRING(&_2$$3, "11");
		ZEPHIR_CALL_FUNCTION(NULL, "dump", NULL, 0, &_2$$3);
		zephir_check_call_status();
		RETURN_CCTOR(&obj);
	}
	zephir_read_property(&_3, this_ptr, SL("shareUseClosures"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&obj, "call_user_func", NULL, 8, &_3, container);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, alias) {
	...
	if (Z_TYPE_P(alias) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(alias), _1$$3, _2$$3, _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "alias", &_3, 69, &key, &item);
			zephir_check_call_status();
		...
		zephir_is_iterable(value, 0, "leevel/di/container.zep", 210);
...
PHP_METHOD(Leevel_Di_Container, make) {
	...
	if (_8) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 70, &args, this_ptr);
		ZEPHIR_UNREF(&args);
		zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, getAlias) {
	...
	if (zephir_array_isset(&_1, name)) {
		...
		zephir_array_fetch(&_0, &_2, name, PH_NOISY, "leevel/di/container.zep", 305 TSRMLS_CC);
	} else {
...
PHP_METHOD(Leevel_Di_Container, parseInjection) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&param, 0, "leevel/di/container.zep", 364);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&param), _0)
	{
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_5$$3, zephir_get_internal_ce(SL("reflectionexception")) TSRMLS_CC)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$8, "leevel/di/container.zep", 360 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Leevel_Di_Container, parseClassInstance) {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "leevel/di/container.zep", 405 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Di_Container, parseClassFromContainer) {
	...
	if (zephir_class_exists(&itemMake, 1 TSRMLS_CC)) {
		...
		if (Z_TYPE_P(&result) != IS_OBJECT) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$6, "leevel/di/container.zep", 432 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		RETURN_CCTOR(&result);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_5, "leevel/di/container.zep", 438 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Leevel_Di_Container, parseClassNotExists) {
	...
	if (Z_TYPE_P(&result) != IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$4, "leevel/di/container.zep", 457 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(&result);
...
PHP_METHOD(Leevel_Di_Container, parseReflection) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Unsupported callback types.", "leevel/di/container.zep", 479);
	return;
...
PHP_METHOD(Leevel_Di_Container, parseClosureReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 71, injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 72);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, parseMethodReflection) {
	...
	zephir_array_fetch_long(&_0, injection, 0, PH_NOISY | PH_READONLY, "leevel/di/container.zep", 511 TSRMLS_CC);
	zephir_array_fetch_long(&_1, injection, 1, PH_NOISY | PH_READONLY, "leevel/di/container.zep", 511 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 73, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&param, &reflection, "getparameters", NULL, 74);
	zephir_check_call_status();
	if (ZEPHIR_IS_EMPTY(&param)) {
		ZEPHIR_INIT_NVAR(&param);
		array_init(&param);
...
PHP_METHOD(Leevel_Di_Container, parseClassReflection) {
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 75, &injection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &reflection, "isinstantiable", NULL, 76);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "leevel/di/container.zep", 532 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&constructor, &reflection, "getconstructor", NULL, 77);
	zephir_check_call_status();
...
PHP_METHOD(Leevel_Di_Container, newInstanceArgs) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 75, classname);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_RETURN_CALL_METHOD(&_0$$3, "newinstanceargs", NULL, 78, args);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM();
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(&_1, zephir_get_internal_ce(SL("reflectionexception")) TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$4, "__construct", NULL, 75, classname);
			zephir_check_call_status();
			ZEPHIR_RETURN_CALL_METHOD(&_3$$4, "newinstancewithoutconstructor", NULL, 79);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
...
PHP_METHOD(Leevel_Di_Container, parseAlias) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "key", NULL, 57, &name);
	zephir_check_call_status();
	zephir_array_fast_append(return_value, &_0);
	ZEPHIR_CALL_FUNCTION(&_0, "current", NULL, 56, &name);
	zephir_check_call_status();
	zephir_array_fast_append(return_value, &_0);
	RETURN_MM();
...
PHP_METHOD(Leevel_Di_Container, offsetUnset) {
	...
	zephir_array_fast_append(&prop, &_1);
	zephir_is_iterable(&prop, 0, "leevel/di/container.zep", 634);
...
PHP_METHOD(Leevel_Di_Container, __call) {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "leevel/di/container.zep", 669 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
