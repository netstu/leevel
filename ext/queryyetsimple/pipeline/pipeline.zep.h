...
ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_pipeline_pipeline_then, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(queryyetsimple_pipeline_pipeline_method_entry) {
	...
	PHP_ME(Queryyetsimple_Pipeline_Pipeline, traverseGenerator, NULL, ZEND_ACC_PROTECTED)
