...
PHP_METHOD(Queryyetsimple_Pipeline_Pipeline, traverseGenerator) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 57, &args, &next);
	ZEPHIR_UNREF(&args);
	zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Pipeline_Pipeline, stageGenerator) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 57, &stage, &_0);
	ZEPHIR_UNREF(&stage);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 42, &temp);
	zephir_check_call_status();
	RETURN_MM();
