...
ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_view_connect_deletevar, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(queryyetsimple_view_connect_method_entry) {
	...
	PHP_ME(Queryyetsimple_View_Connect, deleteVar, arginfo_queryyetsimple_view_connect_deletevar, ZEND_ACC_PUBLIC)
