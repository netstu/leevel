...
PHP_METHOD(Queryyetsimple_View_Provider_Register, viewView) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_35__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Queryyetsimple_View_Provider_Register, viewCompiler) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_36__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Queryyetsimple_View_Provider_Register, viewParser) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_37__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Queryyetsimple_View_Provider_Register, viewTwigParser) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_38__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "view.twig.parser");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "singleton", NULL, 0, &_1, &_0);
	zephir_check_call_status();
