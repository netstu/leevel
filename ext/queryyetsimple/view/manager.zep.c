...
PHP_METHOD(Queryyetsimple_View_Manager, createConnect) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 92, connect);
...
PHP_METHOD(Queryyetsimple_View_Manager, makeConnectHtml) {
	...
	ZEPHIR_CALL_METHOD(NULL, &html, "__construct", NULL, 93, &options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &html, "setparseresolver", NULL, 94, &parser);
	zephir_check_call_status();
	RETURN_CCTOR(&html);
