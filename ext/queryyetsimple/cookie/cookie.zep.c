...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, set) {
	...
	if (_2) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Cookie value must be scalar or null", "queryyetsimple/cookie/cookie.zep", 79);
		return;
	}
	zephir_array_fetch_string(&_3, &arrOption, SL("prefix"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 82 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_4);
	ZEPHIR_CONCAT_VV(&_4, &_3, &sName);
	zephir_get_strval(&sName, &_4);
	_5 = Z_TYPE_P(mixValue) == IS_NULL;
	if (!(_5)) {
		zephir_array_fetch_string(&_6, &arrOption, SL("expire"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 84 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_7, &arrOption, SL("expire"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 92 TSRMLS_CC);
	zephir_array_fetch_string(&_8, &arrOption, SL("expire"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 94 TSRMLS_CC);
	if (ZEPHIR_GT_LONG(&_7, 0)) {
		ZEPHIR_INIT_VAR(&_9$$8);
		zephir_time(&_9$$8);
		zephir_array_fetch_string(&_10$$8, &arrOption, SL("expire"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 93 TSRMLS_CC);
	...
	if (_15) {
		ZEPHIR_INIT_VAR(&_16);
		zephir_array_fetch_string(&_17, _SERVER, SL("HTTPS"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 100 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_18, &arrOption, SL("expire"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 104 TSRMLS_CC);
	zephir_array_fetch_string(&_19, &arrOption, SL("path"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 104 TSRMLS_CC);
	zephir_array_fetch_string(&_20, &arrOption, SL("domain"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 104 TSRMLS_CC);
	zephir_array_fetch_string(&_21, &arrOption, SL("httponly"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 104 TSRMLS_CC);
	ZVAL_BOOL(&_22, (booHttp ? 1 : 0));
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 17, &sName, mixValue, &_18, &_19, &_20, &_22, &_21);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, put) {
	...
	zephir_is_iterable(mixKey, 0, "queryyetsimple/cookie/cookie.zep", 127);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, push) {
	...
	zephir_check_call_status();
	zephir_array_append(&arr, mixValue, PH_SEPARATE, "queryyetsimple/cookie/cookie.zep", 141);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, arraysDelete) {
	...
	zephir_is_iterable(&arrDeleteKey, 0, "queryyetsimple/cookie/cookie.zep", 217);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, get) {
	...
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&arrOption, &_0);
	zephir_array_fetch_string(&_1, &arrOption, SL("prefix"), PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 231 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_2);
	ZEPHIR_CONCAT_VV(&_2, &_1, &sName);
	zephir_get_strval(&sName, &_2);
	if (zephir_array_isset(_COOKIE, &sName)) {
		zephir_array_fetch(&_4$$3, _COOKIE, &sName, PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 234 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "isjson", NULL, 0, &_4$$3);
		zephir_check_call_status();
		if (zephir_is_true(&_3$$3)) {
			zephir_array_fetch(&_5$$4, _COOKIE, &sName, PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 235 TSRMLS_CC);
			zephir_json_decode(return_value, &_5$$4, zephir_get_intval(&__$true) );
			RETURN_MM();
		}
		zephir_array_fetch(&_6$$3, _COOKIE, &sName, PH_NOISY | PH_READONLY, "queryyetsimple/cookie/cookie.zep", 237 TSRMLS_CC);
		RETURN_CTOR(&_6$$3);
	} else {
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, clear) {
	...
	zephir_array_fetch_string(&strPrefix, &arrOption, SL("prefix"), PH_NOISY, "queryyetsimple/cookie/cookie.zep", 266 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "");
	zephir_array_update_string(&arrOption, SL("prefix"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(&_2);
	zephir_is_iterable(_COOKIE, 0, "queryyetsimple/cookie/cookie.zep", 278);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, option) {
	...
	if (!(Z_TYPE_P(&strName) == IS_STRING)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Option set name must be a string.", "queryyetsimple/cookie/cookie.zep", 290);
		return;
	}
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, options) {
	...
	zephir_is_iterable(&arrOption, 0, "queryyetsimple/cookie/cookie.zep", 327);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, getOption) {
	...
	if (zephir_array_isset(&_1, &strName)) {
		...
		zephir_array_fetch(&_0, &_2, &strName, PH_NOISY, "queryyetsimple/cookie/cookie.zep", 339 TSRMLS_CC);
	} else {
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, deleteOptions) {
	...
	zephir_is_iterable(&arrOption, 0, "queryyetsimple/cookie/cookie.zep", 390);
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, isJson) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "json_last_error", NULL, 20);
	zephir_check_call_status();
