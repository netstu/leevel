...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, set) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 30, &name, value, &_18, &_19, &_20, &_22, &_21);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, merge) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "array_unique", NULL, 31, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Cookie_Cookie, pop) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "array_diff", NULL, 32, &_0, &value);
	zephir_check_call_status();
