...
ZEPHIR_INIT_CLASS(Queryyetsimple_Collection_Collection) {
	...
	ZEPHIR_REGISTER_CLASS(Queryyetsimple\\Collection, Collection, queryyetsimple, collection_collection, queryyetsimple_collection_collection_method_entry, 0);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_collection_collection_ce, SL("elements"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var boolean
	 */
	zend_declare_property_bool(queryyetsimple_collection_collection_ce, SL("valid"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	zend_class_implements(queryyetsimple_collection_collection_ce TSRMLS_CC, 1, zend_ce_arrayaccess);
	zend_class_implements(queryyetsimple_collection_collection_ce TSRMLS_CC, 1, spl_ce_Countable);
	zend_class_implements(queryyetsimple_collection_collection_ce TSRMLS_CC, 1, zephir_get_internal_ce(SL("jsonserializable")));
	return SUCCESS;
...
PHP_METHOD(Queryyetsimple_Collection_Collection, make) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 32, elements, type);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, current) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("current", NULL, 33, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, key) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("key", NULL, 34, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, next) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&next, "next", NULL, 35, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, rewind) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(NULL, "reset", NULL, 36, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (1) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Queryyetsimple_Collection_Collection, toArray) {
	...
	zephir_read_property(&_1, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("array_map", NULL, 37, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, prev) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&prev, "prev", NULL, 38, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (1) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Queryyetsimple_Collection_Collection, end) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(&end, "end", NULL, 39, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	if (0) {
		zephir_update_property_zval(this_ptr, SL("valid"), &__$true);
...
PHP_METHOD(Queryyetsimple_Collection_Collection, index) {
	...
	if (Z_TYPE_P(value) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&key, "array_search", NULL, 40, value, &_0$$4, &_1$$4);
		zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, slice) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("array_slice", NULL, 41, &_0, &_1, &length);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, map) {
	...
	zephir_read_property(&_0, this_ptr, SL("elements"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("array_column", NULL, 42, &_0, key, value);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, checkType) {
	...
	ZEPHIR_CALL_CE_STATIC(&_1, queryyetsimple_support_type_ce, "these", &_2, 0, value, &_3);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		RETURN_MM_NULL();
	}
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 30, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Collection_Collection, getArrayElements) {
	...
	if (Z_TYPE_P(elements) == IS_ARRAY) {
		...
		RETURN_MM();
	} else if (zephir_is_instance_of(elements, SL("Queryyetsimple\\Collection\\self") TSRMLS_CC)) {
		ZEPHIR_RETURN_CALL_METHOD(elements, "all", NULL, 0);
		zephir_check_call_status();
		RETURN_MM();
	} else if (zephir_instance_of_ev(elements, queryyetsimple_support_iarray_ce TSRMLS_CC)) {
		ZEPHIR_RETURN_CALL_METHOD(elements, "toarray", NULL, 0);
		zephir_check_call_status();
		RETURN_MM();
	} else if (zephir_instance_of_ev(elements, queryyetsimple_support_ijson_ce TSRMLS_CC)) {
