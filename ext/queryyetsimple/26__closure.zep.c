...
ZEPHIR_INIT_CLASS(queryyetsimple_26__closure) {

	ZEPHIR_REGISTER_CLASS(queryyetsimple, 26__closure, queryyetsimple, 26__closure, queryyetsimple_26__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	return SUCCESS;

}

PHP_METHOD(queryyetsimple_26__closure, __invoke) {

	zend_class_entry *_5 = NULL;
	zephir_fcall_cache_entry *_3 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *project, project_sub, option, options, item, tmp, _0, *_1, _4, _6, _2$$3;
	...
	ZEPHIR_INIT_VAR(&tmp);
	zephir_create_array(&tmp, 19, 0 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_0);
	...
	zephir_array_fast_append(&tmp, &_0);
	zephir_is_iterable(&tmp, 0, "queryyetsimple/router/provider/register.zep", 116);
	...
	if (zephir_has_constructor(return_value TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0, project, &_6, &options);
		zephir_check_call_status();
	}
	RETURN_MM();
