...
ZEPHIR_INIT_CLASS(queryyetsimple_31__closure) {
	...
	ZEPHIR_REGISTER_CLASS(queryyetsimple, 31__closure, queryyetsimple, 31__closure, queryyetsimple_31__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(queryyetsimple_31__closure, __invoke) {
	...
	if (!_4) {
	_4 = zephir_fetch_class_str_ex(SL("Queryyetsimple\\Throttler\\Throttler"), ZEND_FETCH_CLASS_AUTO);
	}
