...
ZEPHIR_INIT_CLASS(queryyetsimple_12__closure) {
	...
	ZEPHIR_REGISTER_CLASS(queryyetsimple, 12__closure, queryyetsimple, 12__closure, queryyetsimple_12__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(queryyetsimple_12__closure, __invoke) {
	...
	if (!_1) {
	_1 = zephir_fetch_class_str_ex(SL("Queryyetsimple\\Encryption\\Encryption"), ZEND_FETCH_CLASS_AUTO);
	}
