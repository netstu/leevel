...
ZEPHIR_INIT_CLASS(Queryyetsimple_Log_Monolog) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Log, Monolog, queryyetsimple, log_monolog, queryyetsimple_log_connect_ce, queryyetsimple_log_monolog_method_entry, 0);
	 ...
	 * @var \Monolog\Logger
	 */
	zend_declare_property_null(queryyetsimple_log_monolog_ce, SL("monolog"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_log_monolog_ce, SL("option"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_log_monolog_ce, SL("supportLevel"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Queryyetsimple_Log_Monolog, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, queryyetsimple_log_monolog_ce, getThis(), "__construct", &_0, 0, &option);
...
PHP_METHOD(Queryyetsimple_Log_Monolog, getDailyFilePath) {
	...
	ZVAL_LONG(&_0, 4);
	ZEPHIR_CALL_FUNCTION(&ext, "pathinfo", NULL, 31, &path, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&ext)) {
		ZEPHIR_INIT_VAR(&_1$$3);
		ZEPHIR_CONCAT_SV(&_1$$3, ".", &ext);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "strrpos", NULL, 87, &path, &_1$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_3$$3, 0);
