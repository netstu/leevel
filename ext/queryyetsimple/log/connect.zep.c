...
ZEPHIR_INIT_CLASS(Queryyetsimple_Log_Connect) {
	...
	ZEPHIR_REGISTER_CLASS(Queryyetsimple\\Log, Connect, queryyetsimple, log_connect, queryyetsimple_log_connect_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);
...
PHP_METHOD(Queryyetsimple_Log_Connect, checkSize) {
	...
	zephir_fcall_cache_entry *_1 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *filepath_param = NULL, __$true, filedir, _0, _3, _5, _6, _10, _12, _13, _14, _7$$3, _8$$3, _9$$3, _15$$4, _16$$4, _17$$4;
	zval filepath;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_FUNCTION(&filedir, "dirname", NULL, 10, &filepath);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_0, "is_file", &_1, 11, &filepath);
	zephir_check_call_status();
	_2 = !zephir_is_true(&_0);
	if (_2) {
		ZEPHIR_CALL_FUNCTION(&_3, "is_dir", NULL, 12, &filedir);
		zephir_check_call_status();
	...
	if (_4) {
		ZVAL_LONG(&_5, 0777);
		ZEPHIR_CALL_FUNCTION(&_6, "mkdir", NULL, 13, &filedir, &_5, &__$true);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_10, "is_file", &_1, 11, &filepath);
	zephir_check_call_status();
	...
	if (_11) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_14, "filesize", NULL, 14, &filepath);
		zephir_check_call_status();
	...
	if (_11) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "rename", NULL, 16, &filepath, &_17$$4);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Queryyetsimple_Log_Connect, getPath) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *level_param = NULL, filepath, _0$$3, _1$$3, _3$$3, _4$$3, _6$$3, _7$$3;
	zval level, _5$$3;
	zval *this_ptr = getThis();
