...
ZEPHIR_INIT_CLASS(Queryyetsimple_Log_Log) {
	 ...
	 */
	zend_declare_property_null(queryyetsimple_log_log_ce, SL("connect"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_log_log_ce, SL("logs"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var callable
	 */
	zend_declare_property_null(queryyetsimple_log_log_ce, SL("filter"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var callable
	 */
	zend_declare_property_null(queryyetsimple_log_log_ce, SL("processor"), ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	zend_class_implements(queryyetsimple_log_log_ce TSRMLS_CC, 1, queryyetsimple_option_iclass_ce);
	return SUCCESS;
...
PHP_METHOD(Queryyetsimple_Log_Log, log) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "date", NULL, 23, &_4);
	zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Log_Log, options) {
	...
	zephir_is_iterable(&option, 0, "queryyetsimple/log/log.zep", 427);
...
PHP_METHOD(Queryyetsimple_Log_Log, getOption) {
	...
	if (zephir_array_isset(&_1, &name)) {
		...
		zephir_array_fetch(&_0, &_2, &name, PH_NOISY, "queryyetsimple/log/log.zep", 439 TSRMLS_CC);
	} else {
...
PHP_METHOD(Queryyetsimple_Log_Log, deleteOptions) {
	...
	zephir_is_iterable(&option, 0, "queryyetsimple/log/log.zep", 490);
...
PHP_METHOD(Queryyetsimple_Log_Log, formatMessage) {
	...
	if (_0) {
		_0 = zephir_is_instance_of(message, SL("Queryyetsimple\\Log\\Ijson") TSRMLS_CC);
	}
	_1 = Z_TYPE_P(message) == IS_OBJECT;
	if (_1) {
		_1 = zephir_is_instance_of(message, SL("Queryyetsimple\\Log\\Iarray") TSRMLS_CC);
	}
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_RuntimeException, "Message is invalid.", "queryyetsimple/log/log.zep", 526);
	return;
