...
ZEPHIR_INIT_CLASS(Queryyetsimple_Support_ClosureUse) {
	...
	ZEPHIR_REGISTER_CLASS(Queryyetsimple\\Support, ClosureUse, queryyetsimple, support_closureuse, queryyetsimple_support_closureuse_method_entry, 0);
	 ...
	 * @var \Closure
	 */
	zend_declare_property_null(queryyetsimple_support_closureuse_ce, SL("closures"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_support_closureuse_ce, SL("args"), ZEND_ACC_PROTECTED TSRMLS_CC);

	queryyetsimple_support_closureuse_ce->create_object = zephir_init_properties_Queryyetsimple_Support_ClosureUse;
	return SUCCESS;
...
PHP_METHOD(Queryyetsimple_Support_ClosureUse, make) {
	...
	ZEPHIR_CALL_METHOD(NULL, &newclosure, "__construct", NULL, 109, closures, &args);
