...
ZEPHIR_INIT_CLASS(Queryyetsimple_Event_EventProvider) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Event, EventProvider, queryyetsimple, event_eventprovider, queryyetsimple_di_provider_ce, queryyetsimple_event_eventprovider_method_entry, 0);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_event_eventprovider_ce, SL("listeners"), ZEND_ACC_PROTECTED TSRMLS_CC);

	queryyetsimple_event_eventprovider_ce->create_object = zephir_init_properties_Queryyetsimple_Event_EventProvider;
	return SUCCESS;
