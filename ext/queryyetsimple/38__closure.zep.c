...
ZEPHIR_INIT_CLASS(queryyetsimple_38__closure) {

	ZEPHIR_REGISTER_CLASS(queryyetsimple, 38__closure, queryyetsimple, 38__closure, queryyetsimple_38__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	return SUCCESS;

}

PHP_METHOD(queryyetsimple_38__closure, __invoke) {
