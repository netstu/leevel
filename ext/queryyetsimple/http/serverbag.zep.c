...
ZEPHIR_INIT_CLASS(Queryyetsimple_Http_ServerBag) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Http, ServerBag, queryyetsimple, http_serverbag, queryyetsimple_http_bag_ce, queryyetsimple_http_serverbag_method_entry, 0);
...
PHP_METHOD(Queryyetsimple_Http_ServerBag, getHeaders) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1), _3, _4, _2)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_7$$3, "in_array", &_8, 90, &key, &contentHeaders, &__$true);
