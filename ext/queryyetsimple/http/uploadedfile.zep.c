 ...
 */
ZEPHIR_INIT_CLASS(Queryyetsimple_Http_UploadedFile) {

	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Http, UploadedFile, queryyetsimple, http_uploadedfile, queryyetsimple_http_file_ce, queryyetsimple_http_uploadedfile_method_entry, 0);
	 ...
	 * @var string
	 */
	zend_declare_property_null(queryyetsimple_http_uploadedfile_ce, SL("originalName"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(queryyetsimple_http_uploadedfile_ce, SL("mimeType"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var int|null
	 */
	zend_declare_property_null(queryyetsimple_http_uploadedfile_ce, SL("error"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_http_uploadedfile_ce, SL("errors"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);
 ...
 * @return string|null
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getOriginalName) {
 ...
 * @return string
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getOriginalExtension) {
	...
	ZVAL_LONG(&_1, 4);
	ZEPHIR_RETURN_CALL_FUNCTION("pathinfo", NULL, 42, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
 ...
 * @return string|null
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getMimeType) {
 ...
 * @return int
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getError) {
 ...
 * @return bool
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, isValid) {
	...
	if (_1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_3, "is_uploaded_file", NULL, 92, &_2);
		zephir_check_call_status();
 ...
 * {@inheritdoc}
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, move) {
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_PARENT(queryyetsimple_http_uploadedfile_ce, getThis(), "__construct", &_2, 0, &target);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_VAR(&_3);
	object_init_ex(&_3, queryyetsimple_http_fileexception_ce);
 ...
 * @return int
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getMaxFilesize) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "ini_get", NULL, 93, &_0);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_3, 0)) {
		ZVAL_LONG(&_6$$4, 16);
		ZEPHIR_CALL_FUNCTION(&_7$$4, "intval", &_8, 94, &max, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&max, &_7$$4);
	} else if (ZEPHIR_IS_LONG_IDENTICAL(&_5, 0)) {
		ZVAL_LONG(&_9$$5, 8);
		ZEPHIR_CALL_FUNCTION(&_10$$5, "intval", &_8, 94, &max, &_9$$5);
		zephir_check_call_status();
 ...
 * @return string
 */
PHP_METHOD(Queryyetsimple_Http_UploadedFile, getErrorMessage) {
	...
	zephir_read_static_property_ce(&_1, queryyetsimple_http_uploadedfile_ce, SL("errors"), PH_NOISY_CC | PH_READONLY);
...
void zephir_init_static_properties_Queryyetsimple_Http_UploadedFile(TSRMLS_D) {
	...
	zend_update_static_property(queryyetsimple_http_uploadedfile_ce, ZEND_STRL("errors"), &_0);
	ZEPHIR_MM_RESTORE();
