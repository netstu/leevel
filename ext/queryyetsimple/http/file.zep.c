...
PHP_METHOD(Queryyetsimple_Http_File, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_file", NULL, 19, &path);
...
PHP_METHOD(Queryyetsimple_Http_File, move) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 25, &target);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Http_File, getTargetFile) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_dir", &_1, 20, &directory);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "is_writable", NULL, 26, &directory);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		ZVAL_LONG(&_3$$3, 511);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "mkdir", NULL, 21, &directory, &_3$$3, &__$true);
		zephir_check_call_status();
		_5$$3 = ZEPHIR_IS_FALSE_IDENTICAL(&_4$$3);
		if (_5$$3) {
			ZEPHIR_CALL_FUNCTION(&_6$$3, "is_dir", &_1, 20, &directory);
			zephir_check_call_status();
...
PHP_METHOD(Queryyetsimple_Http_File, moveToTarget) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "move_uploaded_file", NULL, 27, &sourcePath, &target);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		ZEPHIR_CALL_FUNCTION(&error, "error_get_last", NULL, 28);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_1$$3);
		...
		ZEPHIR_CALL_FUNCTION(&_3$$3, "strip_tags", NULL, 29, &_2$$3);
		zephir_check_call_status();
