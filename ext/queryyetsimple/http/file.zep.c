...
ZEPHIR_INIT_CLASS(Queryyetsimple_Http_File) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Http, File, queryyetsimple, http_file, spl_ce_SplFileObject, queryyetsimple_http_file_method_entry, 0);
...
PHP_METHOD(Queryyetsimple_Http_File, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_file", NULL, 28, &path);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		ZEPHIR_INIT_VAR(&_1$$3);
		object_init_ex(&_1$$3, queryyetsimple_http_filenotfoundexception_ce);
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 2, &path);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "queryyetsimple/http/file.zep", 45 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_PARENT(NULL, queryyetsimple_http_file_ce, getThis(), "__construct", NULL, 0, &path);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Queryyetsimple_Http_File, move) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *directory_param = NULL, *name_param = NULL, target, _0;
	zval directory, name;
	zval *this_ptr = getThis();
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 1, 1, &directory_param, &name_param);
	...
	zephir_check_call_status();
	object_init_ex(return_value, queryyetsimple_http_file_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 34, &target);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Queryyetsimple_Http_File, getTargetFile) {
	...
	zval *directory_param = NULL, *name_param = NULL, __$true, target, _0, _2, _13, _14, _15, _3$$3, _4$$3, _6$$3, _7$$4, _8$$4, _9$$4, _10$$5, _11$$5, _12$$5;
	zval directory, name;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_dir", &_1, 29, &directory);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "is_writable", NULL, 35, &directory);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		ZVAL_LONG(&_3$$3, 511);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "mkdir", NULL, 30, &directory, &_3$$3, &__$true);
		zephir_check_call_status();
		_5$$3 = ZEPHIR_IS_FALSE_IDENTICAL(&_4$$3);
		if (_5$$3) {
			ZEPHIR_CALL_FUNCTION(&_6$$3, "is_dir", &_1, 29, &directory);
			zephir_check_call_status();
			_5$$3 = !zephir_is_true(&_6$$3);
		}
		if (_5$$3) {
			ZEPHIR_INIT_VAR(&_7$$4);
			object_init_ex(&_7$$4, queryyetsimple_http_fileexception_ce);
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_7$$4, "queryyetsimple/http/file.zep", 81 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else if (!(zephir_is_true(&_2))) {
		ZEPHIR_INIT_VAR(&_10$$5);
		object_init_ex(&_10$$5, queryyetsimple_http_fileexception_ce);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_10$$5, "queryyetsimple/http/file.zep", 84 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_13);
...
PHP_METHOD(Queryyetsimple_Http_File, moveToTarget) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "move_uploaded_file", NULL, 36, &sourcePath, &target);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		ZEPHIR_CALL_FUNCTION(&error, "error_get_last", NULL, 37);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_1$$3);
		object_init_ex(&_1$$3, queryyetsimple_http_fileexception_ce);
		zephir_array_fetch_string(&_2$$3, &error, SL("message"), PH_NOISY | PH_READONLY, "queryyetsimple/http/file.zep", 105 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "strip_tags", NULL, 38, &_2$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "queryyetsimple/http/file.zep", 105 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
