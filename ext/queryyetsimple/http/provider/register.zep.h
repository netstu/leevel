...
extern zend_class_entry *queryyetsimple_http_provider_register_ce;
...
ZEPHIR_INIT_FUNCS(queryyetsimple_http_provider_register_method_entry) {
	PHP_ME(Queryyetsimple_Http_Provider_Register, __construct, arginfo_queryyetsimple_http_provider_register___construct, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
