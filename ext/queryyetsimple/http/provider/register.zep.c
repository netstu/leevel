 ...
 * @version 1.0
 */
ZEPHIR_INIT_CLASS(Queryyetsimple_Http_Provider_Register) {

	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Http\\Provider, Register, queryyetsimple, http_provider_register, queryyetsimple_di_provider_ce, queryyetsimple_http_provider_register_method_entry, 0);
 ...
 * @return void
 */
PHP_METHOD(Queryyetsimple_Http_Provider_Register, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, queryyetsimple_http_provider_register_ce, getThis(), "__construct", &_0, 0, container);
...
PHP_METHOD(Queryyetsimple_Http_Provider_Register, response) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_11__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
