...
ZEPHIR_INIT_CLASS(Queryyetsimple_I18n_I18n) {
	 ...
	 * @var string
	 */
	zend_declare_property_null(queryyetsimple_i18n_i18n_ce, SL("i18n"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(queryyetsimple_i18n_i18n_ce, SL("text"), ZEND_ACC_PROTECTED TSRMLS_CC);
