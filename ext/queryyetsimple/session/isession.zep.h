...
ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setname, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setid, 0, 0, 1)
	ZEND_ARG_INFO(0, id)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setsavepath, 0, 0, 1)
	ZEND_ARG_INFO(0, savepath)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setcookiedomain, 0, 0, 1)
	ZEND_ARG_INFO(0, domain)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setcacheexpire, 0, 0, 1)
	ZEND_ARG_INFO(0, second)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setcachelimiter, 0, 0, 1)
	ZEND_ARG_INFO(0, limiter)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_queryyetsimple_session_isession_setgcprobability, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(queryyetsimple_session_isession_method_entry) {
	...
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setName, arginfo_queryyetsimple_session_isession_setname)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getName, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setId, arginfo_queryyetsimple_session_isession_setid)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getId, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setSavePath, arginfo_queryyetsimple_session_isession_setsavepath)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getSavePath, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setCookieDomain, arginfo_queryyetsimple_session_isession_setcookiedomain)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getCookieDomain, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setCacheExpire, arginfo_queryyetsimple_session_isession_setcacheexpire)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setUseCookies, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setCacheLimiter, arginfo_queryyetsimple_session_isession_setcachelimiter)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getCacheLimiter, NULL)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, setGcProbability, arginfo_queryyetsimple_session_isession_setgcprobability)
	PHP_ABSTRACT_ME(Queryyetsimple_Session_ISession, getGcProbability, NULL)
	PHP_FE_END
};
