...
ZEPHIR_INIT_CLASS(Queryyetsimple_Session_Middleware_Session) {
	...
	ZEPHIR_REGISTER_CLASS(Queryyetsimple\\Session\\Middleware, Session, queryyetsimple, session_middleware_session, queryyetsimple_session_middleware_session_method_entry, 0);
	 ...
	 */
	zend_declare_property_null(queryyetsimple_session_middleware_session_ce, SL("manager"), ZEND_ACC_PROTECTED TSRMLS_CC);
