...
ZEPHIR_INIT_CLASS(Queryyetsimple_Session_Provider_Register) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Queryyetsimple\\Session\\Provider, Register, queryyetsimple, session_provider_register, queryyetsimple_di_provider_ce, queryyetsimple_session_provider_register_method_entry, 0);
...
PHP_METHOD(Queryyetsimple_Session_Provider_Register, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, queryyetsimple_session_provider_register_ce, getThis(), "__construct", &_0, 0, container);
...
PHP_METHOD(Queryyetsimple_Session_Provider_Register, providers) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Queryyetsimple\\Session\\Manager");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Qys\\Session\\Manager");
	zephir_array_fast_append(&_0, &_1);
	zephir_array_update_string(&tmp, SL("sessions"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_array(&_0, 4, 0 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Queryyetsimple\\Session\\Session");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Queryyetsimple\\Session\\ISession");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Qys\\Session\\Session");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Qys\\Session\\ISession");
	zephir_array_fast_append(&_0, &_1);
	zephir_array_update_string(&tmp, SL("session"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Queryyetsimple\\Session\\Middleware\\Session");
...
PHP_METHOD(Queryyetsimple_Session_Provider_Register, session) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, queryyetsimple_29__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
...
PHP_METHOD(Queryyetsimple_Session_Provider_Register, middleware) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "Queryyetsimple\\Session\\Middleware\\Session");
