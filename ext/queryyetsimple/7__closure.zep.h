...
extern zend_class_entry *queryyetsimple_7__closure_ce;
...
ZEPHIR_INIT_FUNCS(queryyetsimple_7__closure_method_entry) {
	PHP_ME(queryyetsimple_7__closure, __invoke, arginfo_queryyetsimple_7__closure___invoke, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_FE_END
};
